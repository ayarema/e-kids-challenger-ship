...
# А також нам потрібно створити щось, що буде в нашому об'єкті, це майбутня іконка нашого Space Invader 3000
...
# Також ми можемо контролювати FPS (частоту кадрів у секунду) у нашій грі, для цього давайте зробимо наступне -
CLOCK = pygame.time.Clock()
FPS = 60  # кількість кадрів на екрані за секунду.
...
while RUNNING:
    ...
    for event in pygame.event.get():
        ...
        pygame.display.update()  # Або pygame.display.flip()
